...
class MediaReport extends Report
{
    /**
     * @inheritdoc
     */
    ...
    {
        return new ReportQuery(get_called_class(), ['object_type' => Report::OBJECT_TYPE_MEDIA]);
    }
    ...
    {
        $this->setAttribute('object_type', Report::OBJECT_TYPE_MEDIA);
